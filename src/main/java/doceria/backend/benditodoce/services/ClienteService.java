...
import doceria.backend.benditodoce.domain.Cidade;
import doceria.backend.benditodoce.domain.Cliente;
import doceria.backend.benditodoce.domain.Endereco;
import doceria.backend.benditodoce.domain.enums.Perfil;
import doceria.backend.benditodoce.domain.enums.TipoCliente;
import doceria.backend.benditodoce.dto.ClienteDTO;
import doceria.backend.benditodoce.dto.ClienteNewDTO;
import doceria.backend.benditodoce.repositories.CidadeRepository;
import doceria.backend.benditodoce.repositories.ClienteRepository;
import doceria.backend.benditodoce.repositories.EnderecoRepository;
